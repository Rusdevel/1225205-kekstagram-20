...
// Создание  массива сомментариев
  var getComment = function (count) {
    var avatar = 'img/avatar-' + getRandomNumber(MIN_NUMBER_AVATAR, MAX_NUMBER_AVATER) + '.svg';
    var comments = [];
  ...
  var photoDescription = function(){
    ...
    for (var i = 1; i <= NUMBER_OF_PHOTOS; i++){
      objectPhotoDescription.push = ({
        ...
        comments: getComment(getRandomNumber(MIN_NUMBER_AVATAR, MAX_NUMBER_AVATER))
      });
    }
